...
# Cấu tạo & Vai trò
$$
MVVM = (Model + View + ViewModel) * Binder
$$
...
## Model
- Chứa dữ liệu.
- Thuần dữ liệu, không chứa bất kỳ logic phức tạp nào cả.
...
>→ View là công cụ người dùng sử dụng để biến đổi dữ liệu.

## View Model
- Là lớp chính giữa, chịu trách nhiệm trực tiếp kết nối giữa Model và View.
- Chứa logic biến đổi dữ liệu, khi:
...
> → View Model là:
> - Là lớp trung gian chịu trách nhiệm kết nối một hoặc hai chiều giữa Model ↔ view. 
> - Là nơi dữ liệu được biến đổi trước khi bàn giao cho hai lớp còn lại.
